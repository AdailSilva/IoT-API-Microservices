...
@RestController
@RequestMapping(value = "/hr-eureka-server")
public class HrEurekaServerResource {

	private static Logger logger = LoggerFactory.getLogger(HrEurekaServerResource.class);
